...
namespace TiendaKarate.Migrations
{
    ...
    [Migration("20240219190937_AgeGenderStockMigration")]
    partial class AgeGenderStockMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TiendaKarate.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "1234",
                            Role = true,
                            SignUpDate = new DateTime(2024, 2, 19, 20, 9, 37, 478, DateTimeKind.Local).AddTicks(2398)
                        });
                });
