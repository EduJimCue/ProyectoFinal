...
namespace TiendaKarate.Migrations
{
    ...
    [Migration("20240219191512_SizeRelationMigration")]
    partial class SizeRelationMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TiendaKarate.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "1234",
                            Role = true,
                            SignUpDate = new DateTime(2024, 2, 19, 20, 15, 12, 399, DateTimeKind.Local).AddTicks(6871)
                        });
                });
