...
namespace TiendaKarate.Migrations
{
    ...
    [Migration("20240516111524_ProductImages")]
            ...
            modelBuilder.Entity("TiendaKarate.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2024, 5, 16, 13, 15, 24, 524, DateTimeKind.Local).AddTicks(9370),
                            Paid = false,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("TiendaKarate.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "1234",
                            Role = true,
                            SignUpDate = new DateTime(2024, 5, 16, 13, 15, 24, 524, DateTimeKind.Local).AddTicks(9074)
                        });
                });
