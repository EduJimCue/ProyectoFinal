...
namespace TiendaKarate.Migrations
{
    ...
    [Migration("20240303131802_SizeProductChangeMigration")]
    partial class SizeProductChangeMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TiendaKarate.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2024, 3, 3, 14, 18, 1, 910, DateTimeKind.Local).AddTicks(8141),
                            Paid = false,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("TiendaKarate.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "1234",
                            Role = true,
                            SignUpDate = new DateTime(2024, 3, 3, 14, 18, 1, 910, DateTimeKind.Local).AddTicks(7865)
                        });
                });
