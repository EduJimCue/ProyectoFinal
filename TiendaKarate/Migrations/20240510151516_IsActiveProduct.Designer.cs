...
namespace TiendaKarate.Migrations
{
    ...
    [Migration("20240510151516_IsActiveProduct")]
            ...
            modelBuilder.Entity("TiendaKarate.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2024, 5, 10, 17, 15, 15, 961, DateTimeKind.Local).AddTicks(1359),
                            Paid = false,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("TiendaKarate.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "1234",
                            Role = true,
                            SignUpDate = new DateTime(2024, 5, 10, 17, 15, 15, 961, DateTimeKind.Local).AddTicks(1045)
                        });
                });
